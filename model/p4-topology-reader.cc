...
P4TopologyReader::Link::Link ( Ptr<Node> fromPtr, const std::string &fromName, const std::string &fromType,unsigned int fromLinkedSwitchIndex, 
      Ptr<Node> toPtr, const std::string &toName, const std::string &toType,unsigned int toLinkedSwitchIndex)
{
  m_fromPtr = fromPtr;
  m_fromName = fromName;
  m_fromType = fromType;
  m_fromLinkedSwitchIndex = fromLinkedSwitchIndex;
  m_toPtr = toPtr;
  m_toName = toName;
  m_toType = toType;
  m_toLinkedSwitchIndex = toLinkedSwitchIndex;
}
...
std::string
P4TopologyReader::Link::GetFromNodeName (void) const
{
  return m_fromName;
}
...
std::string
P4TopologyReader::Link::GetToNodeName (void) const
{
  return m_toName;
}
...
unsigned int 
P4TopologyReader::Link::GetFromLinkedSwitchIndex(void) const
{
  return m_fromLinkedSwitchIndex;
}
unsigned 
int P4TopologyReader::Link::GetToLinkedSwitchIndex(void) const
{
  return m_toLinkedSwitchIndex;
}
...
P4TopologyReader::Link::ConstAttributesIterator

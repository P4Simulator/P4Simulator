...
#ifndef P4_TOPOLOGY_READER_NEW_H
#define P4_TOPOLOGY_READER_NEW_H
		...
		*/
		...
		public:
			...
			*/
			...
			Link(Ptr<Node> fromPtr, unsigned int fromIndex, char fromType, Ptr<Node> toPtr,unsigned int toIndex,char toType);
...
#endif /* P4_TOPOLOGY_READER_NEW_H */
